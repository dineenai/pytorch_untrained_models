...
import helper_shape_bias.human_categories as hc
...
class ImageNetProbabilitiesTo16ClassesMapping(ProbabilitiesToDecisionMapping):
    ...
    # Áine Added 28/04/25
    def label_to_16class(self, label_idx):
        """
        Given an ImageNet class index (0-999), return the corresponding 16-class label.
        """
