...
#     valdir = os.path.join(args.data, 'val') # Need to change Val to val in folders as this is the directory name on server
    ...
    # FIX THIS LATER
    # # import mean and std values from file
    # band = args.band
    # norm_values = '/home/ainedineen/blurry_vision/pytorch_untrained_models/imagenet/imagenet_image_stats/calc_stats_revised_method/bandpass_stats/mean_std_values.txt'
    # # load file as dataframe
    # df = pd.read_csv(norm_values, sep='\t')
    # label = df['band']
    ...
    # # High
    # mean = [0.0544, 0.054, 0.0543]
    # std = [0.0767, 0.077, 0.0763]

    # # Low #CAUTION LOW WAS TRAINED WITH HIGH PARAMETERS!!!!!!!!!
    # mean = [0.0544, 0.054, 0.0543]
    # std = [0.0767, 0.077, 0.0763]

    # Actual low
    mean = [0.49029, 0.46657, 0.41384]
    std = [0.26021, 0.2528, 0.26843]

    # # Mid
    # mean = [0.09104, 0.08941, 0.08867]
    # std = [0.10367, 0.10187, 0.10266]
