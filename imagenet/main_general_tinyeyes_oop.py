...
from infantTransforms.TinyEyesTransformOOPcuda import TinyEyes
...
parser.add_argument('--tinyeyes_width', default=29, type=float, metavar='N',
                    help='width must be a positive value (cm)')
parser.add_argument('--tinyeyes_dist', default=27, type=float, metavar='N',
...
#     valdir = os.path.join(args.data, 'val') # Need to change Val to val in folders as this is the directory name on server
    ...
    if args.tinyeyesweek==None:
        ...
        # Instantiate TinyEyes class
        TinyEyes_withParams = TinyEyes(age=args.tinyeyesweek, width=args.tinyeyes_width, dist=args.tinyeyes_dist)
