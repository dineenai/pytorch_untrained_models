...
def save_checkpoint(state, is_best, filename='checkpoint_unsupervised_resnet50_gauss_4_for_60_epoch.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'model_best_unsupervised_resnet50_gauss_4_for_60_epoch.pth.tar')
