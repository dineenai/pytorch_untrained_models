...
parser.add_argument('--tinyeyes_width', default=15.8, type=float, metavar='N',
                    help='width must be a positive value (cm)')
parser.add_argument('--tinyeyes_dist', default=60, type=float, metavar='N',
                    help='dist must be a positive value (cm)')
parser.add_argument('--tinyeyesweek', default=None, type=str, metavar='N',
                    help="Please choose one of the following possible ages: ['week0', 'week4', 'week8', 'week12', 'week24', 'adult']")
    ...
    if args.tinyeyesweek==None:
        ...
        train_dataset = datasets.ImageFolder(
            ...
            transforms.Compose([
                ...
                # Note 2/10/23 could make distance randomly sampled? 
                tinyeyes.TinyEyes(args.tinyeyesweek, width=args.tinyeyes_width, dist=args.tinyeyes_dist),
                transforms.RandomHorizontalFlip(),
                transforms.ToTensor(),
                normalize,
            ]))
