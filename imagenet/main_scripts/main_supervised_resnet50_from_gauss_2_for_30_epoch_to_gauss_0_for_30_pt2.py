        ...
        # save running checkpoint From Anna T DeepCluster https://github.com/AnnaTruzzi/deepcluster/blob/backtostart/main.py
            torch.save({'epoch': epoch + 1,
                     ...
                     #  os.path.join(args.exp, 'checkpoint_dc'+str(args.instantiation)+'_epoch'+str(epoch)+'.pth.tar'))
                       os.path.join(args.model_path, 'checkpoint_supervised_resnet50_from_gauss_2_for_30_epoch_to_gauss_0_for_30'+'_epoch'+str(save_epoch)+'.pth.tar'))
...
def save_checkpoint(state, is_best, filename='checkpoint_supervised_resnet50_from_gauss_2_for_30_epoch_to_gauss_0_for_30.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'model_best_supervised_resnet50_from_gauss_2_for_30_epoch_to_gauss_0_for_30.pth.tar')
