#  main_val.py with model import changed to accommodate extended receptive fields in C1
# import torchvision.models as models changes to import resnet_conv1_21 as models 
import argparse
import os
import random
import shutil
