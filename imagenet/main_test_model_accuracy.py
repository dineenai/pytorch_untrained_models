...
parser.add_argument('--save_accuracy_path', default='/home/ainedineen/blurry_vision/pytorch_untrained_models/imagenet/test_out_220222',
...
#         os.makedirs(opt.model_folder)
    ...
    folder_dataset_test = ImageFolderWithPaths(testdir) #works
    ...
    # TRY INSTEAD - CANNOT USE ImageFolder without subdirs 
    # Options: 1. create subdirs 2. use directly by modifying dataloader - where does label come from?
    data_loader = torch.utils.data.DataLoader(testdir,
                                          batch_size=1,
                                          shuffle=True)
