...
#SBATCH --output=/data2/blurry_vision_sup_RN50/supervised_alexnet_bp_butter_low_batches_log_for_60_epoch_params-AN_default_bs-32_res-fixed_iter-1/logs/slurm-%j.out
#SBATCH --error=/data2/blurry_vision_sup_RN50/supervised_alexnet_bp_butter_low_batches_log_for_60_epoch_params-AN_default_bs-32_res-fixed_iter-1/logs/slurm-%j.err
...
LR=0.01
BS=32
RESUME="/data2/blurry_vision_sup_RN50/supervised_alexnet_bp_butter_low_batches_log_for_60_epoch_params-AN_default_bs-32_res-fixed_iter-1/outmodel/checkpoint_supervised_alexnet_bp_butter_low_batches_for_60_epoch_params-AN_default_bs-32_res-fixed_epoch80_complete_log_iter-1.pth.tar"
