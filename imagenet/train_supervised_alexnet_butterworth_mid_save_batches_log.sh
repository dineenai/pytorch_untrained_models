...
#SBATCH --output=/data2/blurry_vision_sup_RN50/supervised_alexnet_bp_butter_mid_batches_log_for_60_epoch_iter-2/logs/slurm-%j.out
#SBATCH --error=/data2/blurry_vision_sup_RN50/supervised_alexnet_bp_butter_mid_batches_log_for_60_epoch_iter-2/logs/slurm-%j.err
...
# RESUME="${OUTFOLDER}/checkpoint_supervised_alexnet_bp_butter_mid_batches_for_60_epoch_epoch1_complete_log_iter-4.pth.tar"
