...
#SBATCH --output=/data2/blurry_vision_sup_RN18/supervised_resnet18_bp_butter_all_batches_log_for_60_epoch_iter-1/logs/slurm-%j.out
#SBATCH --error=/data2/blurry_vision_sup_RN18/supervised_resnet18_bp_butter_all_batches_log_for_60_epoch_iter-1/logs/slurm-%j.err
...
ITER=1
BAND='all'
OUTPTH="/data2/blurry_vision_sup_RN18/supervised_resnet18_bp_butter_${BAND}_batches_log_for_60_epoch_iter-${ITER}"
