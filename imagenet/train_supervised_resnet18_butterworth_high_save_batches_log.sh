...
#SBATCH --output=/data2/blurry_vision_sup_RN50/supervised_resnet18_bp_butter_high_batches_log_for_60_epoch_iter-1/logs/slurm-%j.out
#SBATCH --error=/data2/blurry_vision_sup_RN50/supervised_resnet18_bp_butter_high_batches_log_for_60_epoch_iter-1/logs/slurm-%j.err
