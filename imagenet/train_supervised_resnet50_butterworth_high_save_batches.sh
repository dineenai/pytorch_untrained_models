...
#SBATCH -J high_band_train
#SBATCH --output=/data2/blurry_vision_sup_RN50/supervised_resnet50_bp_butter_high_batches_for_60_epoch_iter-5/logs/slurm-%j.out
#SBATCH --error=/data2/blurry_vision_sup_RN50/supervised_resnet50_bp_butter_high_batches_for_60_epoch_iter-5/logs/slurm-%j.err
...
BAND='high'
OUTPTH="/data/blurry_vision_sup_RN50/supervised_resnet50_bp_butter_${BAND}_batches_for_60_epoch_iter-${ITER}"
...
PRINTFREQ=100
RESUME="${OUTPTH}/outmodel/checkpoint_supervised_resnet50_bp_butter_high_batches_for_60_epoch_epoch1_complete_iter-5.pth.tar"
