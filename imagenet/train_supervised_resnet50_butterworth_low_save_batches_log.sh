...
#SBATCH --output=/data2/blurry_vision_sup_RN50/supervised_resnet50_bp_butter_low_batches_log_for_60_epoch_iter-1/logs/slurm-%j.out
#SBATCH --error=/data2/blurry_vision_sup_RN50/supervised_resnet50_bp_butter_low_batches_log_for_60_epoch_iter-1/logs/slurm-%j.err
...
RESUME="${OUTFOLDER}/checkpoint_supervised_resnet50_bp_butter_low_batches_for_60_epoch_epoch0_complete_log_iter-1.pth.tar"
