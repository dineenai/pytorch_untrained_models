...
#SBATCH --output=/data2/blurry_vision_sup_RN50/supervised_resnet50_bp_butter_mid_batches_log_for_60_epoch_iter-5/logs/slurm-%j.out
#SBATCH --error=/data2/blurry_vision_sup_RN50/supervised_resnet50_bp_butter_mid_batches_log_for_60_epoch_iter-5/logs/slurm-%j.err
