...
BATCH=1
MODEL='resnet50'
AFILE="TEST_sup_RN50_from_gauss_4_for_45_epoch_to_gauss_0_for_15_epoch45"
STIM="16_class_IN"
RESUME="/data/blurry_vision_sup_RN50/supervised_resnet50_from_gauss_4_for_45_epoch_to_gauss_0_for_20/outmodel/checkpoint_supervised_resnet50_from_gauss_4_for_40_epoch_to_gauss_0_for_20_epoch45.pth.tar"



${PYTHON} main_val_shape_bias_df_animals.py --a ${MODEL} \
--print-freq ${PRINT} \
--batch-size ${BATCH} \
--resume ${RESUME} \
